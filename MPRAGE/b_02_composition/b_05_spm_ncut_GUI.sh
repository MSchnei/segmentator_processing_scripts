...
for (( i=0; i<${tLen}; i++ )); do
  subj=${arr_t1[i]}
  input_name1="${parent_path}/${subj}/derived/04_composition/spm_T1_PD_T2s/ilr_coord_1.nii.gz"
  input_name2="${parent_path}/${subj}/derived/04_composition/spm_T1_PD_T2s/ilr_coord_2.nii.gz"
  input_ncut="${parent_path}/${subj}/derived/04_composition/spm_T1_PD_T2s/ilr_coord_1${ncut_base}"
